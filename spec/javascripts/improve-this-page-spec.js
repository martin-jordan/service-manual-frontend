   ...
   var FIXTURE =
    '<div class="improve-this-page">' +
      '<div class="js-prompt">' +
        ...
        '</div>' +
      '</div>' +
      '<div id="improveThisPageForm" class="improve-this-page__form js-feedback-form js-hidden" data-track-category="improve-this-page" data-track-action="give-feedback">' +
        '<a href="#" class="improve-this-page__close js-close-feedback-form">Close</a>' +
